-- Políticas RLS CORREGIDAS Y OPTIMIZADAS para el sistema de chat
-- Elimina recursión infinita y mejora el rendimiento
...
-- Los usuarios pueden ver conversaciones donde son participantes (usando EXISTS para evitar recursión)
...
COMMENT ON TABLE chat_notifications IS 'Notificaciones del sistema de chat - Acceso para usuarios autenticados';
COMMENT ON TABLE conversations IS 'Conversaciones del chat - Acceso basado en participación';
COMMENT ON TABLE messages IS 'Mensajes de las conversaciones - Acceso basado en participación';
COMMENT ON TABLE conversation_participants IS 'Participantes de las conversaciones - Acceso basado en participación';

-- 9. Verificar que las políticas están activas
SELECT 
  schemaname, 
  tablename, 
  policyname, 
