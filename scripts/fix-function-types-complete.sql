-- Script para corregir completamente la función update_service_with_age_ranges
-- Ejecutar en Supabase SQL Editor
-- SOLUCIONA el error "CASE types integer and text cannot be matched"
...
-- =====================================================
-- 2. CREAR FUNCIÓN CON TIPOS CORRECTOS
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '✅ Tipos de datos corregidos (INTEGER vs TEXT)';
