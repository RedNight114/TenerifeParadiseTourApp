-- Script para limpiar y recrear el sistema de chat completo (VERSIÓN CORREGIDA)
...
-- NOTA: No se eliminan trabajos cron ya que la extensión pg_cron no está disponible
-- en todos los planes de Supabase. La limpieza se hará manualmente.
...
-- =====================================================
-- PASO 8: INSERTAR CONFIGURACIÓN POR DEFECTO
-- =====================================================
...
-- NOTA IMPORTANTE SOBRE LIMPIEZA AUTOMÁTICA
DO $$
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '⚠️ IMPORTANTE: La extensión pg_cron no está disponible en este plan de Supabase.';
    RAISE NOTICE '   Para mantener el sistema limpio, ejecuta manualmente:';
    RAISE NOTICE '   - SELECT cleanup_expired_typing_indicators(); (diariamente)';
    RAISE NOTICE '   - scripts/27-manual-cleanup-chat.sql (semanalmente)';
    RAISE NOTICE '';
