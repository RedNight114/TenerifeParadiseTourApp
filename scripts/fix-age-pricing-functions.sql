-- =====================================================
-- CORREGIR FUNCIONES DE RANGOS DE EDAD
-- =====================================================
-- Este script corrige los errores en las funciones SQL
-- =====================================================

-- 1. CORREGIR FUNCIÓN PARA INSERTAR/ACTUALIZAR RANGOS DE EDAD
...
-- 2. CORREGIR FUNCIÓN PARA OBTENER RANGOS DE EDAD
...
BEGIN
    ...
    SELECT
        ...
        CASE
            ...
            ELSE CONCAT(apr.min_age::TEXT, '-', apr.max_age::TEXT, ' años')
        END as age_label
...
-- 4. PROBAR LAS FUNCIONES CON UN SERVICIO EXISTENTE
...
BEGIN
    ...
    IF test_service_id IS NOT NULL THEN
        ...
        RAISE NOTICE '✅ Función upsert_service_age_ranges probada con servicio %', test_service_id;
        
        -- Probar la función de obtención
        PERFORM get_service_age_ranges(test_service_id);
        
        RAISE NOTICE '✅ Función get_service_age_ranges probada con servicio %', test_service_id;
    ELSE
...
SELECT '🎉 Sistema de rangos de edad corregido y funcionando!' as final_status;
