-- Script para añadir campo sender_role a la tabla messages
-- Ejecutar en Supabase SQL Editor

-- =====================================================
-- PASO 1: AÑADIR CAMPO sender_role A LA TABLA messages
-- =====================================================
...
-- =====================================================
-- PASO 2: CREAR FUNCIÓN PARA DETERMINAR ROL DEL USUARIO
-- =====================================================
...
-- =====================================================
-- PASO 3: CREAR TRIGGER PARA AUTO-ASIGNAR sender_role
-- =====================================================
...
-- =====================================================
-- PASO 4: ACTUALIZAR MENSAJES EXISTENTES
-- =====================================================
...
-- =====================================================
-- PASO 5: CREAR VISTA MEJORADA PARA MENSAJES
-- =====================================================
