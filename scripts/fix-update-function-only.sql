-- Script para corregir SOLO la función update_service_with_age_ranges
...
-- Eliminar la función si existe (con cualquier combinación de parámetros)
...
-- =====================================================
-- 2. RECREAR FUNCIÓN CON PARÁMETROS CORRECTOS
-- =====================================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ Función update_service_with_age_ranges recreada exitosamente';
    RAISE NOTICE '✅ Parámetros: (service_id_param UUID, service_data JSONB)';
