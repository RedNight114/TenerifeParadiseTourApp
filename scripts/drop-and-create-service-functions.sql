-- Script para eliminar y recrear las funciones de servicios
-- Primero eliminamos las funciones existentes, luego las recreamos

-- ========================================
-- PASO 1: ELIMINAR FUNCIONES EXISTENTES
-- ========================================

-- Eliminar función create_service_simple si existe
DROP FUNCTION IF EXISTS public.create_service_simple(jsonb) CASCADE;

-- Eliminar función update_service_simple si existe
DROP FUNCTION IF EXISTS public.update_service_simple(uuid, jsonb) CASCADE;

-- Eliminar función delete_service_simple si existe
...
DO $$
BEGIN
    RAISE NOTICE '✅ Funciones de servicios creadas exitosamente!';
    RAISE NOTICE '📋 Funciones disponibles:';
    RAISE NOTICE '   - create_service_simple(jsonb)';
    RAISE NOTICE '   - update_service_simple(uuid, jsonb)';
    RAISE NOTICE '   - delete_service_simple(uuid)';
END $$;
