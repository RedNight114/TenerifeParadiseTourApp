-- Script para limpiar completamente y recrear el sistema de servicios
-- Ejecutar en Supabase SQL Editor
-- SOLUCIONA el error "cannot change name of input parameter"

-- =====================================================
-- 1. LIMPIAR FUNCIONES EXISTENTES
-- =====================================================

-- Eliminar todas las funciones relacionadas con servicios
DROP FUNCTION IF EXISTS create_service_with_age_ranges(jsonb);
DROP FUNCTION IF EXISTS update_service_with_age_ranges(uuid, jsonb);
DROP FUNCTION IF EXISTS update_service_with_age_ranges(jsonb, uuid);
DROP FUNCTION IF EXISTS delete_service_complete(uuid);
DROP FUNCTION IF EXISTS upsert_service_age_ranges(uuid, jsonb);
DROP FUNCTION IF EXISTS upsert_service_age_ranges(jsonb, uuid);

-- =====================================================
-- 2. VERIFICAR LIMPIEZA
-- =====================================================

-- Verificar que no quedan funciones
SELECT 
...
-- =====================================================
-- 3. RECREAR TABLA age_price_ranges
-- =====================================================

-- Eliminar tabla si existe (CUIDADO: esto eliminará datos existentes)
...
-- =====================================================
-- 4. RECREAR FUNCIÓN upsert_service_age_ranges
-- =====================================================
...
-- =====================================================
-- 5. RECREAR FUNCIÓN create_service_with_age_ranges
-- =====================================================
...
-- =====================================================
-- 6. RECREAR FUNCIÓN update_service_with_age_ranges
-- =====================================================
...
-- =====================================================
-- 7. RECREAR FUNCIÓN delete_service_complete
-- =====================================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ Sistema de servicios limpiado y recreado completamente';
    RAISE NOTICE '✅ Todas las funciones eliminadas y recreadas';
    RAISE NOTICE '✅ Parámetros corregidos';
