...
/**
 * Script para probar con exactamente los mismos datos del error SIS0042
 * Usa el número de pedido real del error para verificar el cálculo de la firma
 */

require('dotenv').config({ path: '.env.local' });
const crypto = require('crypto');

console.log('🔍 PRUEBA CON DATOS EXACTOS DEL ERROR SIS0042');
console.log('=============================================');
...
// Recrear exactamente los mismos parámetros del comercio
console.log('\n🔧 RECREANDO PARÁMETROS EXACTOS:');
console.log('==================================');
...
console.log('   Merchant Parameters recreados:', Object.keys(merchantParameters).length, 'campos');
...
console.log('\n🔐 GENERANDO FIRMA CON DATOS EXACTOS:');
console.log('======================================');
...
if (calculatedSignature !== errorData.signature) {
  ...
  console.log('   Diferencia en caracteres:', Math.abs(errorData.signature.length - calculatedSignature.length));
  
  // Mostrar los primeros caracteres de ambas firmas
  ...
  console.log('\n   Posibles causas:');
  console.log('   1. La clave secreta no es la correcta');
  console.log('   2. Los parámetros del comercio son diferentes');
  console.log('   3. El formato de los datos es diferente');
  console.log('   4. Hay espacios o caracteres ocultos');
  
  // Verificar si los parámetros del comercio son exactamente iguales
  console.log('\n   Verificando parámetros del comercio...');
  ...
  console.log('   El problema SIS0042 está resuelto');
  console.log('   La configuración es válida');
}

// Crear datos del formulario para comparar
...
console.log('\n✅ Prueba con datos exactos completada'); 