-- Script para corregir search_path de funciones eliminando dependencias
-- Ejecutar en el SQL Editor de Supabase
-- Elimina triggers y funciones antes de recrearlas

-- =====================================================
-- 1. ELIMINAR TRIGGERS Y DEPENDENCIAS
-- =====================================================
...
CREATE TRIGGER trigger_update_updated_at_reservations
    BEFORE UPDATE ON public.reservations
    FOR EACH ROW
    EXECUTE FUNCTION public.update_updated_at_column();

CREATE TRIGGER trigger_update_updated_at_payments
...
SELECT 
    'CORRECCIÓN COMPLETA CON DEPENDENCIAS' as mensaje,
