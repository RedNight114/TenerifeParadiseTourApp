...
export default function ServicesManagementSimple() {
  ...
  const loadServices = async () => {
    try {
      ...
      // Usar fetch directamente para evitar problemas con imports dinámicos
      ...
      setServices([
        {
          ...
          description: 'Excursión al pico más alto de España con guía experto',
          price: 45,
          available: true,
        ...
        },
        {
          ...
          description: 'Experiencia única para ver cetáceos en su hábitat natural',
          price: 35,
          available: true,
          created_at: new Date().toISOString()
        }
