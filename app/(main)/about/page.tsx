        ...
        <div className="relative container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-white/95 leading-relaxed drop-shadow-md">
              ...
              somos tus amigos locales en la isla donde las montañas se encuentran con el océano.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                ...
                <p>
                  Como nativos de Tenerife, hemos crecido explorando cada rincón de esta isla mágica. Desde las majestuosas
                  montañas que se encuentran con el océano turquesa hasta las calas escondidas de la costa, conocemos
                  los lugares que hacen que Tenerife sea verdaderamente especial.
                </p>
                <p>
                ...
                <p className="font-semibold text-[#0061A8]">
                  Cada aventura que diseñamos lleva un pedacito de nuestro corazón canario y la belleza de nuestra costa.
                </p>
              </div>
            </div>
            <div className="relative">
              <div className="relative h-96 rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Hermosa costa de Tenerife con montañas y océano"
                  fill
