                ...
                <CardContent>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-[#0061A8] to-[#F4C762] hover:from-[#0061A8]/90 hover:to-[#F4C762]/90 text-white font-semibold py-3 text-lg"
                    >
                      {isSubmitting ? (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="bg-gray-200 rounded-2xl h-96 flex items-center justify-center shadow-lg">
            <div className="text-center text-gray-500">
              ...
              <p className="text-sm">Santa Cruz de Tenerife, Canarias</p>
              <Button className="mt-4 bg-[#0061A8] hover:bg-[#0061A8]/90">Ver en Google Maps</Button>
            </div>
          </div>
        </div>
      </section>
